...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2024 at 11:45 PM
...
INSERT INTO `chat-chat recipients table` (`Chat-Chat Recipients ID`, `Chat ID`, `Chat Recipients ID`, `Chat Muted`, `Chat Favourited`, `Is Read`) VALUES
(13, 6, 1, 0, 0, 1),
(14, 6, 2, 0, 0, 1),
(15, 7, 1, 0, 1, 1),
(16, 7, 2, 0, 1, 1),
...
--
-- Dumping data for table `chat-date/time table`
--

INSERT INTO `chat-date/time table` (`Chat ID`, `Date Created`, `Time Created`) VALUES
(6, '2024-05-12', '15:50:54'),
(8, '2024-05-12', '15:52:58');
...
('63kmm26izhqxffc3mri7l6qpwzl78w23', 'eyJlbXBsb3llZV9pZCI6MX0:1s6AgS:U8yPmUgb-z7U2kIK3O1IYWqRE3Nlyfd68YEbMemc_mk', '2024-05-26 15:00:16.580806');
...
(4, 'Cool group', 'This group chat is used for members of the text-chat subsystem to communicate', '2024-05-12', '15:51:28'),
(5, 'group to delete', 'This group chat is used for members of the text-chat subsystem to communicate', '2024-05-12', '15:56:03');
...
(4, 'Glyn has invited you to the Cool group Groupchat'),
(5, 'Glyn has invited you to the Cool group'),
(6, 'Haamid has invited you to the group to delete Groupchat');
...
(47, 'Hello', '', '2024-05-12', '15:51:03', 0),
(48, 'whats up', '', '2024-05-12', '15:51:36', 0),
(49, 'hello', '', '2024-05-12', '15:53:06', 0);
...
(10, 'Glyn sent: Hello', 0),
(11, 'Glyn sent: whats up', 0),
(12, 'Haamid sent: hello', 0);
...
--
ALTER TABLE `chat-chat recipients table`
  MODIFY `Chat-Chat Recipients ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `chat table`
--
ALTER TABLE `chat table`
  MODIFY `Chat ID` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `group table`
  MODIFY `Group ID` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `invitation table`
--
ALTER TABLE `invitation table`
  MODIFY `Invitation ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `message table`
--
ALTER TABLE `message table`
  MODIFY `Message ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `notification table`
--
ALTER TABLE `notification table`
  MODIFY `Notification ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `project-employee table`
  ...
  ADD CONSTRAINT `userID_from_users_to_project-emp` FOREIGN KEY (`UserID`) REFERENCES `employee table` (`Employee ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `usertasks`
  ...
  ADD CONSTRAINT `fk_UserID` FOREIGN KEY (`UserID`) REFERENCES `employee table` (`Employee ID`);
COMMIT;
