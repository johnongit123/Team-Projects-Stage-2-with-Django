...
if ((!in_array($project_id, array_column($user_projects, "ProjectID")))And  ($_SESSION["user_type"] == "User")) {
    echo "<h1>User not a member of this project!</h1>". $_SESSION["user_type"];
