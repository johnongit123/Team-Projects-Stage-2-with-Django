...
if (isset($_POST["delete-post-id"])) {
    ...
    header("Location: ../manager/posts.php?" . $_POST["topic-id"]);
}
    ...
    <main class="main-content">
        <section class="forum-container central column-container">
            ...
            <header class="row-container">
                <h1 class="breadcrumb"> <a href="../manager/threads.php">Forum</a> > <a href="../manager/posts.php?<?=$post["ThreadID"]?>">Topic Details</a> > <b>Post Details</b> </h1>
