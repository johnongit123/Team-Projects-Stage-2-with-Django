...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2024 at 06:29 PM
...
CREATE TABLE `invitation-recipients table` (
  ...
  `Invitation Accepted` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `chat table`
  MODIFY `Chat ID` mediumint(9) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `message table`
--
ALTER TABLE `message table`
  MODIFY `Message ID` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `group table`
  MODIFY `Group ID` smallint(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `invitation table`
--
ALTER TABLE `invitation table`
  MODIFY `Invitation ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `report table`
--
ALTER TABLE `report table`
  MODIFY `Report ID` bigint(20) NOT NULL AUTO_INCREMENT;
